      ...
      <main className="flex-1 container mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12 max-w-5xl">
        ...
        <div className="space-y-6">
          ...
          <PolicySection 
            ...
            content="We use WeatherAPI.com to provide weather data. Please refer to their privacy policy for information about how they handle data. We do not share your personal information with any other third parties."
          />
