    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50/30 to-cyan-50/30 dark:from-gray-900 dark:via-gray-900 dark:to-gray-900 transition-colors flex flex-col">
      ...
      <main className="flex-1 container mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12 max-w-5xl">
        ...
        <div className="space-y-6">
          ...
          <TermSection 
            title="3. Weather Data Accuracy"
            content="While we strive to provide accurate weather information, we cannot guarantee the accuracy, completeness, or timeliness of the data. Weather data is provided by third-party services and should not be relied upon for critical decisions without verification."
          />
          ...
          <TermSection 
            ...
            content="The service and its original content, features, and functionality are owned by Weather AQI and are protected by international copyright, trademark, and other intellectual property laws. The weather data is provided by WeatherAPI.com and subject to their terms."
          />
          
          <TermSection 
            title="6. Third-Party Services"
            content="Our service uses WeatherAPI.com for weather data. Your use of weather data is also subject to WeatherAPI.com's terms of service and privacy policy. We are not responsible for the content or practices of third-party services."
          />
